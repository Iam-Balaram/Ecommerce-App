           ...
           <Link to="/"><img src={assets.logo} alt="logo" className="w-36"/></Link> 
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4">
                    <div className="flex flex-col gap-2 w-36 py-3 px-5 bg-salte-100 text-gray-500 rounded ">
                ...
                <Link to="/cart" className="relative">
                    ...
                    <p className="absolute right-{-5px]  bottom-[-5px] w-4 text-center leading-4 bg-black text-white aspect-squer rounded-full text-[8px]">{getCartCount()}</p>
                </Link>
